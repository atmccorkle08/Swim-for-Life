...
function FooterLogo() {
  return (
    <Link href="/" className="flex items-center gap-2">
      ...
      <span className="text-lg font-bold text-white">Swim For Life</span>
    </Link>
  );
}
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-400">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+19178213667" className="hover:text-white transition-colors">
                  (917)-821-3667
                </a>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="h-4 w-4 flex-shrink-0" />
                <a href="mailto:atmccorkle08@gmail.com" className="hover:text-white transition-colors">
